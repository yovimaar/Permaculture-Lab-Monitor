...
public class PhGraphActivity  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ph_graph_layout);

        ///////Datepicker stuff/////////////////////////////////////////////////////////////////////////////////////////
        //Christopher King 12/1/2016
        dateView = (TextView) findViewById(R.id.diagnosticP);
    ...
    public void testTime() {
        ...
        TextView diag = (TextView) findViewById(R.id.diagnosticP);
        if (con != null) {
            DataQuery dq = new DataQuery();
            ReadingsAnalizer ra = new ReadingsAnalizer();
            ArrayList<Reading> readings;
            Log.v("Connection", "Not Null");
            readings = dq.getLatestPHs(fromTS, toTS); //1 is moisture type
    ...
    public void updateDataSets() {
        ...
        if (con != null) {
            ...
            Log.v("Connection", "Not Null");
            readings = dq.getLatestPHs(fromTS, toTS);// Set1 buttons
            history = dq.getLatestPHs(fromTS2, toTS2);// Set2 buttons
            Log.v("DATA SETS!!!!!!!!!", "FROM : " + fromTS.toString() + "\n" + "     TO: " + toTS.toString());
