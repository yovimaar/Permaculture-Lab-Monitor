...
public class TempGraphActivity  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.temp_graph_layout);


        ///////Datepicker stuff/////////////////////////////////////////////////////////////////////////////////////////
        //Christopher King 12/1/2016
        dateView = (TextView) findViewById(R.id.diagnosticT);
    ...
    public void testTime() {
        ...
        TextView diag = (TextView) findViewById(R.id.diagnosticT);
        if (con != null) {
            DataQuery dq = new DataQuery();
            ReadingsAnalizer ra = new ReadingsAnalizer();
            ArrayList<Reading> readings;
            Log.v("Connection", "Not Null");
            readings = dq.getLatestTemps(fromTS, toTS); //1 is moisture type
    ...
    public void updateDataSets() {
        ...
        if (con != null) {
            ...
            Log.v("Connection", "Not Null");
            readings = dq.getLatestTemps(fromTS, toTS);// Set1 buttons
            history = dq.getLatestTemps(fromTS2, toTS2);// Set2 buttons
            Log.v("DATA SETS!!!!!!!!!", "FROM : " + fromTS.toString() + "\n" + "     TO: " + toTS.toString());
