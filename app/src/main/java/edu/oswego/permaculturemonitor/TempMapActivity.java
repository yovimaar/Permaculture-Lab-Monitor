...
public class TempMapActivity extends FragmentActivity implements OnMapReadyCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.temp_map_layout);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        weightedList = (dq.getWeightedFromZone(1, 2));////////////////WILL HAVE TO CHANGE SECOND PARAMETER BASED ON WHAT TYPE OF VALUE YOU WANT//////////////
        list = (dq.getLatLngFromZone(1, 2));////////////////WILL HAVE TO CHANGE SECOND PARAMETER BASED ON WHAT TYPE OF VALUE YOU WANT//////////////
        for(int i = 2; i < 5; i++) {
            weightedList.addAll(dq.getWeightedFromZone(i, 2));////////////////WILL HAVE TO CHANGE SECOND PARAMETER BASED ON WHAT TYPE OF VALUE YOU WANT//////////////
            list.addAll(dq.getLatLngFromZone(i, 2));////////////////WILL HAVE TO CHANGE SECOND PARAMETER BASED ON WHAT TYPE OF VALUE YOU WANT//////////////
        }
        //test if they worked
        ...
        String lowString = SP.getString("lowTemp","0");
        String highString = SP.getString("highTemp","100");
        float low,high;
